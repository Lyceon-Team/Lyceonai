...
We may update this Notice from time to time. When we do, we will update the "Last Updated" date at the top of this Notice. If the changes are material — for example, changes to the renewal frequency, cancellation method, reminder cadence, or any other term that materially affects your subscription rights — we will provide reasonable advance notice, typically by email to the address associated with your account and through in-product notification.
