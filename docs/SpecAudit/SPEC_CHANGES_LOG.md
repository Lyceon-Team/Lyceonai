...
Owner action: amend Doc 10 §2.4 and §9.4 per the Change above, or reverse the 2026-09-16 ruling and narrow `hasActiveGuardianLink` to links whose student is currently 13-17.
