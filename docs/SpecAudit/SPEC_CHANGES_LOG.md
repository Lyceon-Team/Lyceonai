...
Build artifact: none — held by design. `scripts/ci/fk-delete-action-guard.sql` (the four allowlist entries and the `CRISIS_RULING_PENDING` exemption), `tests/ci/deletion-fk-actions.pg.ci.test.ts` FK5.
