...
SCL-165 | 2026-09-25 | The 7-day tutor-conversation retention tier is now scheduled, but NOTHING writes `tutor_conversations.deleted_at` — so a specified retention rule has a permanently empty input and deletes nothing, while the schedule makes it look enforced | PROPOSED
