-- =====================================================================
-- SUPABASE AUTH MIGRATION - SIMPLIFIED FERPA-ALIGNED SCHEMA
-- =====================================================================
-- Simplified version for SAT practice app (students + admin only)
-- No teacher-student mapping complexity
-- =====================================================================
...
-- =====================================================================
-- 1. PROFILES TABLE (Student + Admin roles only)
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS public.answer_attempts (
  ...
  student_id uuid REFERENCES public.profiles(id) ON DELETE CASCADE NOT NULL,
  question_id varchar REFERENCES public.questions(id) ON DELETE SET NULL,
...
-- Students can view and update their own profile (cannot change role)
...
-- =====================================================================
-- SAFE QUESTIONS VIEW (No Answers for Students)
-- =====================================================================
...
-- ✅ profiles (student/admin roles only)
-- ✅ practice_sessions
-- ✅ answer_attempts
-- ✅ admin_audit_logs
