 ...
 * plain English: guardian COPPA-consent verification surface. All failure copy is curated and
 * static (verification-flow wording, not sign-in copy) — a raw server/exception string is never
 * rendered in the error toast or the Verification-Error card. Deliberately uses its own static
 * chokepoint rather than resolveAuthErrorMessage (whose generic copy is sign-in-flavored).
 */
export default function GuardianConsentVerify() {
  ...
  const verifyMutation = useMutation({
    mutationFn: async (sid: string) => {
      ...
      if (!res.ok) {
        // Never carry the raw server JSON into the Error — the verification surface shows curated,
        // static copy only (defense-in-depth at the throw; anti-leak per AS-3).
  ...
  const checkoutMutation = useMutation({
    ...
    onError: () => {
      toast({
        ...
        description:
          "We couldn't start guardian verification. Please try again.",
      });
    },
  });
        ...
        <Container className="py-24">
          <Card className="max-w-xl mx-auto p-8 text-center border-green-100 bg-green-50/30">
            ...
            <p className="text-lg text-green-800 mb-8">
              Thank you! You have successfully verified your identity and
              granted consent for <strong>{request?.childName}</strong> to use
              Lyceon.
            </p>
            <div className="space-y-4">
              <p className="text-sm text-green-700">
                A parent account has been created for you at{" "}
                <strong>{request?.guardianEmail}</strong>. Please check your
                email for a link to set your password and access your dashboard.
              </p>
        ...
        <Container className="py-24">
          <Card className="max-w-xl mx-auto p-8 text-center">
            ...
            <p className="text-muted-foreground mb-8">
              {requestError
                ? "We couldn't find this consent request. It may have expired or been already approved."
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-lg">
              Give <strong>{request?.childName}</strong> permission to use
              Lyceon's AI SAT Tutoring platform.
            </p>
          </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Federal law (COPPA) requires us to obtain verifiable
              ...
              <div className="space-y-6">
                ...
                <div
                  ...
                  onClick={() =>
                    setCheckedItems((prev) => ({
                      ...prev,
                      consentPrivacy: !prev.consentPrivacy,
                    }))
                  }
                >
                  <Checkbox
                  ...
                  <div className="grid gap-1.5 leading-none">
                    <label
                      ...
                      className="text-sm font-medium leading-none cursor-pointer"
                    >
                      I consent to the collection and use of my child's personal
                      information as described in Lyceon's{" "}
                      <a
                ...
                <div
                  ...
                  onClick={() =>
                    setCheckedItems((prev) => ({
                      ...prev,
                      revokeAccess: !prev.revokeAccess,
                    }))
                  }
                >
                  <Checkbox
                  ...
                  <div className="grid gap-1.5 leading-none">
                    <label
                      ...
                      className="text-sm font-medium leading-none cursor-pointer"
                    >
                      I understand that I can revoke this consent or request
                      deletion of my child's data at any time by contacting
                      hello@lyceon.ai.
                    </label>
                  </div>
                </div>
                  ...
                  <div className="grid gap-1.5 leading-none">
                    ...
                    >
                      ...
                      <a
                        ...
                        onClick={(e) => e.stopPropagation()}
                      >
                        Parent/Guardian Terms of Service
                      </a>
                      .
                    </label>
                  </div>
              ...
              <div className="pt-6 border-t border-border">
                <div className="mb-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    To satisfy legal requirements for "verifiable parental
                    consent," we use a credit card charge of $0.50 to confirm
                    you are an adult.
                  </p>
                  <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-3 text-xs text-yellow-800 flex gap-2">
                    <AlertTriangle className="w-4 h-4 flex-shrink-0" />
                    <span>
                      This charge will be immediately cancelled/voided. It only
                      appears on your statement as "Lyceon Verification".
                    </span>
                  </div>
                </div>
                ...
                {isCanceled && (
                  <p className="text-center text-xs text-amber-700 mt-4">
                    Verification was canceled. Please try again when you are
