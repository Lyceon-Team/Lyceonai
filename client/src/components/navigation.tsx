...
import { UserCircle, Settings, LogOut, Users } from "lucide-react";
...
export default function Navigation() {
  ...
  const { user, isAuthenticated, isAdmin, isGuardian, authLoading, signOut } =
    useSupabaseAuth();
              ...
              <DropdownMenu>
                ...
                >
                  <div className="px-2 py-2">
                    ...
                    {isAdmin && (
                      <p
                        className="text-xs text-foreground font-medium mt-1"
                    ...
                    {isGuardian && (
                      <p
                        className="text-xs text-foreground font-medium mt-1"
                        data-testid="text-guardian-badge"
                      >
                        Guardian
                      </p>
                    )}
