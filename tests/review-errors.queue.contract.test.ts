...
describe('Review queue runtime contract', () => {
  ...
  it('builds deterministic unresolved queue from canonical misses and dedupes by question', async () => {
    setupSupabase({
      ...
      fullLengthQuestionRows: [
        { module_id: 'module-a', question_id: 'q4', question_canonical_id: 'SATM1GHI789', question_stem: 'Q4 stem', question_section: 'M', question_difficulty: 'hard', question_domain: 'adv', question_skill: 's4', question_subskill: 'ss4' },
