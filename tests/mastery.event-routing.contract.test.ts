...
describe("Mastery Event Routing Contract", () => {
  it("maps practice submit outcomes through applyMasteryEvent with sourceFamily=practice", () => {
  ...
  it("maps full-test outcomes through applyMasteryEvent with sourceFamily=test", () => {
