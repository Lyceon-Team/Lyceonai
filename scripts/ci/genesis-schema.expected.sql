...
BEGIN
  ...
  ELSIF p_privacy_mode = 'anonymize' THEN
    ...
    -- @spec [Doc 05E §6 INV-05E-07, strengthened; SCL-120 (PROPOSED); owner brief 2026-09-25 R2]
...
DECLARE
  ...
  v_sweep_sql      constant text :=
    ...
    'with NO exclusions — the deleted_profile_id carve-out was dropped 2026-09-25 (SCL-121)';
BEGIN
