...
VALUES
  ...
  ('SATM1DGA04', 'M', 1, 'Algebra', ARRAY['ALG.04'], 1,
  ...
  ('SATM1DGA05', 'M', 1, 'Algebra', ARRAY['ALG.05'], 2,
  ...
  ('SATM1DGB01', 'M', 1, 'Advanced Math', ARRAY['AM.01'], 1,
  ...
  ('SATM1DGB02', 'M', 1, 'Advanced Math', ARRAY['AM.02'], 2,
  ...
  ('SATM1DGC01', 'M', 1, 'Problem Solving and Data Analysis', ARRAY['PSDA.01'], 1,
   'Mean of {2,4,6,8,10}?', '[{"token":"A","text":"6"},{"token":"B","text":"5"},{"token":"C","text":"7"},{"token":"D","text":"8"}]'::jsonb,
   'A', '(2+4+6+8+10)/5=30/5=6.', 'published', now()),
  ('SATM1DGC02', 'M', 1, 'Problem Solving and Data Analysis', ARRAY['PSDA.02'], 2,
  ...
  ('SATM1DGC03', 'M', 1, 'Problem Solving and Data Analysis', ARRAY['PSDA.03'], 3,
  ...
  ('SATM1DGC04', 'M', 1, 'Problem Solving and Data Analysis', ARRAY['PSDA.04'], 1,
   '25% of 80?', '[{"token":"A","text":"20"},{"token":"B","text":"25"},{"token":"C","text":"15"},{"token":"D","text":"30"}]'::jsonb,
   'A', '0.25*80=20.', 'published', now()),
  ('SATM1DGC05', 'M', 1, 'Problem Solving and Data Analysis', ARRAY['PSDA.05'], 2,
  ...
  ('SATM1DGD03', 'M', 1, 'Geometry and Trigonometry', ARRAY['GT.03'], 3,
  ...
  ('SATM1DGD04', 'M', 1, 'Geometry and Trigonometry', ARRAY['GT.04'], 1,
  ...
  ('SATM1DGD05', 'M', 1, 'Geometry and Trigonometry', ARRAY['GT.05'], 2,
  ...
  ('SATRW1DGE01', 'RW', 1, 'Information and Ideas', ARRAY['IAI.01'], 1,
  ...
  ('SATRW1DGE02', 'RW', 1, 'Information and Ideas', ARRAY['IAI.02'], 2,
  ...
  ('SATRW1DGE03', 'RW', 1, 'Information and Ideas', ARRAY['IAI.03'], 3,
  ...
  ('SATRW1DGE04', 'RW', 1, 'Information and Ideas', ARRAY['IAI.04'], 1,
  ...
  ('SATRW1DGE05', 'RW', 1, 'Information and Ideas', ARRAY['IAI.05'], 2,
  ...
  ('SATRW1DGF02', 'RW', 1, 'Craft and Structure', ARRAY['CAS.02'], 1,
  ...
  ('SATRW1DGF03', 'RW', 1, 'Craft and Structure', ARRAY['CAS.03'], 3,
  ...
  ('SATRW1DGF04', 'RW', 1, 'Craft and Structure', ARRAY['CAS.04'], 1,
  ...
  ('SATRW1DGF05', 'RW', 1, 'Craft and Structure', ARRAY['CAS.05'], 2,
  ...
  ('SATRW1DGG01', 'RW', 1, 'Expression of Ideas', ARRAY['EOI.01'], 1,
  ...
  ('SATRW1DGG02', 'RW', 1, 'Expression of Ideas', ARRAY['EOI.02'], 2,
  ...
  ('SATRW1DGG03', 'RW', 1, 'Expression of Ideas', ARRAY['EOI.03'], 3,
  ...
  ('SATRW1DGG04', 'RW', 1, 'Expression of Ideas', ARRAY['EOI.04'], 1,
  ...
  ('SATRW1DGG05', 'RW', 1, 'Expression of Ideas', ARRAY['EOI.05'], 2,
  ...
  ('SATRW1DGH01', 'RW', 1, 'Standard English Conventions', ARRAY['SEC.01'], 1,
  ...
  ('SATRW1DGH02', 'RW', 1, 'Standard English Conventions', ARRAY['SEC.02'], 2,
  ...
  ('SATRW1DGH03', 'RW', 1, 'Standard English Conventions', ARRAY['SEC.03'], 3,
  ...
  ('SATRW1DGH04', 'RW', 1, 'Standard English Conventions', ARRAY['SEC.04'], 1,
  ...
  ('SATRW1DGH05', 'RW', 1, 'Standard English Conventions', ARRAY['SEC.05'], 2,
